...
Pod::Spec.new do |s|
  s.name             = "DejaTextView"
  s.version          = "0.1.0"
  s.summary          = "A short description of DejaTextView."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DejaTextView"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Markus Schlegel" => "mail@markus-schlegel.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DejaTextView.git", :tag => s.version.to_s }
